...
import { useDebouncedParam } from "@helpers/debounce";
              ...
              <div className="mb-6">
                ...
                <div className="space-y-1">
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-md text-sm transition-colors ${!params.category ? "bg-primary-50 text-primary-700 font-medium" : "text-gray-600 hover:bg-gray-50"}`}
                  >
                    All Services
                  </button>
                  {categories?.map((cat) => (
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 rounded-md text-sm transition-colors ${params.category === cat.id ? "bg-primary-50 text-primary-700 font-medium" : "text-gray-600 hover:bg-gray-50"}`}
                    >
                      {cat.name}
                    </button>
                  ))}
